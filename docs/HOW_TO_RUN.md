...
- **Missing AI Weights**: The system uses YOLOv8 (`yolov8s.pt`). If the file is missing from the `ai_model/models` directory, the `ultralytics` package should automatically download it on the first run. Ensure you have an active internet connection.
